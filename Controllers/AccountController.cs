...
namespace GAG_101.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        public ActionResult RegisterBusinessUser()
        {
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterBusinessUser(RegisterBusinessUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    var businessUser = new LocalBusinessUsers1
                    {
                        BU_FEIN = model.FEIN,
                        Business_Name = model.BusinessName,
                        Email = model.Email,
                        LocalBusiness_UserID = user.Id,
                        Location_Zip = model.Zip,
                        Name = model.Name,
                        Phone_Number = model.Phone,

                    };

                    UserManager.AddToRole(user.Id, "Local BusinessUser");

                    db.LocalBusinessUsers1.Add(businessUser);
                    db.SaveChanges();
                    ...
                    //General Email Sender....
                    var subject = "welcome to GotAGuy";
                    var body = $"Hi! Thank you for signing up.";
