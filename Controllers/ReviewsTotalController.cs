...
{
    public class ReviewsTotalController : Controller
    {
        ...
        // GET: ReviewsTotal/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ReviewsTotal/Create
